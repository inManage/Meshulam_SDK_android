...
public class SetBitPaymentServerRequest extends SdkServerRequest {
    public static final String REQUEST_NAME = "setBitPayment/";

    public SetBitPaymentServerRequest(String applicationToken, String bitPaymentId , Activity activity, OnServerRequestDoneListener onServerRequestDone) {
        super(REQUEST_NAME, getParams(applicationToken,bitPaymentId), new OptionsRequest(true, true, false), onServerRequestDone, activity);
    }
    ...
    protected BaseServerRequestResponse buildResponse(JSONObject jsonObject) {
        return new SetBitPaymentResponse().createResponse(jsonObject);
    }
    ...
    protected Type getType() {
        return new TypeToken<SetBitPaymentResponse>() {
        }.getType();
    }
}
